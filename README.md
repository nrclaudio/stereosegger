...
The pipeline produces three main types of output files.
...
- **Use Case**: Used for training and as the input for the `predict` step. Contains spatial graphs for 1000x1000 pixel tiles.
